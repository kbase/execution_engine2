...
def test_user_client_set_init_fail():
    ...
    user_client_set_init_fail({'a': 'b'}, None, 'bar', ValueError('user_id is required'))
    user_client_set_init_fail({'a': 'b'}, '    \t  ', 'bar', ValueError('user_id is required'))
    user_client_set_init_fail({'a': 'b'}, 'foo', None, ValueError('token is required'))
    user_client_set_init_fail({'a': 'b'}, 'foo', '    \t   ', ValueError('token is required'))
