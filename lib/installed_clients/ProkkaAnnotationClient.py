...
class ProkkaAnnotation(object):
    ...
    def annotate(self, params, context=None):
        ...
        return self._client.call_method(
            "ProkkaAnnotation.annotate", [params], self._service_ver, context
        )
    ...
    def annotate_metagenome(self, params, context=None):
        ...
        """
        return self._client.call_method(
            "ProkkaAnnotation.annotate_metagenome", [params], self._service_ver, context
        )

    def status(self, context=None):
        return self._client.call_method(
            "ProkkaAnnotation.status", [], self._service_ver, context
        )
