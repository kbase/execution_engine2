...
class execution_engine2(object):
    ...
    def run_job_batch(self, params, batch_params, context=None):
        ...
        """
        return self._client.call_method('execution_engine2.run_job_batch',
                                        [params, batch_params], self._service_ver, context)
    ...
    def abandon_children(self, params, context=None):
        ...
        :returns: instance of type "BatchSubmission" -> structure: parameter
           ...
           "child_job_ids" of list of type "job_id" (A job id.)
        """
        return self._client.call_method('execution_engine2.abandon_children',
                                        [params], self._service_ver, context)
    ...
    def check_job_batch(self, params, context=None):
        ...
        :returns: instance of type "CheckJobBatchResults" (parent_job - state
           ...
           parameter "terminated_code" of Long
        """
        return self._client.call_method('execution_engine2.check_job_batch',
                                        [params], self._service_ver, context)
    ...
    def handle_held_job(self, cluster_id, context=None):
        ...
        return self._client.call_method('execution_engine2.handle_held_job',
                                        [cluster_id], self._service_ver, context)
    ...
    def get_client_groups(self, context=None):
        ...
        """
        return self._client.call_method('execution_engine2.get_client_groups',
                                        [], self._service_ver, context)
