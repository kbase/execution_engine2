...
class execution_engine2:
    ...
    def abandon_children(self, ctx, params):
        ...
        :returns: instance of type "AbandonChildrenResults" (parent_job_id:
           The job id of the batch job child_job_ids: The job ids of the
           child jobs that were abandoned) -> structure: parameter
    ...
    def retry_child_jobs(self, ctx, params):
        ...
        :param params: instance of type "RetryJobsParams" (parent_job_id: the
           ...
           "child_job_ids" of list of type "job_id" (A job id.), parameter
           "as_admin" of type "boolean" (@range [0,1])
        :returns: instance of type "RetryJobsResults" (new_child_jobs_ids:
           the new job ids, in the order we received, or null for a failure
           failed_job_ids: the jobs we couldn't retry for some reason) ->
           structure: parameter "new_child_job_ids" of list of type "job_id"
           (A job id.), parameter "failed_child_job_retry_ids" of list of
           type "job_id" (A job id.), parameter "as_admin" of type "boolean"
           (@range [0,1])
        """
        # ctx is the context object
