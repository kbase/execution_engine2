...
class execution_engine2:
    ...
    GIT_COMMIT_HASH = "bd218d67be688a27152bf99e6538cb98ee6654e0"
    ...
    def check_job_batch(self, ctx, params):
        ...
        :returns: instance of type "CheckJobBatchResults" (parent_job - state
           ...
           itself batch_id - str - the parent of the job, if the job is a
           child job created via run_job_batch batch_job - bool - whether or
           not this is a batch parent container child_jobs - array - Only
           parent container should have child job ids scheduler_type - str -
           ...
           parameter "terminated_code" of Long, parameter "batch_id" of
           String, parameter "child_jobstates" of list of type "JobState"
