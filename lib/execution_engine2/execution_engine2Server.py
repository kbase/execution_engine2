...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_execution_engine2.run_job_concierge,
                             name='execution_engine2.run_job_concierge',
                             types=[dict, dict])
        self.method_authentication['execution_engine2.run_job_concierge'] = 'required'  # noqa
        ...
        self.rpc_service.add(impl_execution_engine2.get_client_groups,
                             name='execution_engine2.get_client_groups',
                             types=[])
        self.method_authentication['execution_engine2.get_client_groups'] = 'required'  # noqa
