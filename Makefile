...
TEST_FILES+= test/ee2_authstrategy_test.py test/ee2_load_test.py test/ee2_SDKMethodRunner_ee2_logs.py test/ee2_test_admin_mode.py

setup-database:
	# Set up travis user in mongo
	pytest -x -v --nocapture --nologcapture test/ee2_check_configure_mongo_docker.py

test:
	# Requires htcondor python bindings
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 test/ee2_scheduler_test.py
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 test/ee2_SDKMethodRunner_test.py
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 test/ee2_MongoUtil_test.py
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 test/ee2_server_test.py
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 test/ee2_load_test.py
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 test/ee2_kafka_test.py

test-models:
	# Requires travis user to be set up
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 test/ee2_model_test.py

test-coverage:
	# Assumes setup-database run in previous step
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 $(TEST_FILES)
...
test-with-docker:
	...
	# Set up travis user in mongo
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 ee2_check_configure_mongo_docker
	# Run tests using python installed in travis, but with mongo and condor running in docker containers
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 test/ee2_scheduler_test.py
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html --cover-package=execution_engine2 ee2_model_test


integration_test:
	./test/dockerfiles/condor/start_condor_docker_travis.sh
	pytest -x -v --nocapture --nologcapture --with-coverage --cover-html test/ee2_scheduler_integration_test.py
